window.addEventListener("DOMContentLoaded", function() {
    ...
    function getTimerReminding(endtime) {
    ...
    // Используем классысоздание карточек меню
    class MenuCard {
    ...
    new MenuCard(
        ...
        "vegy",
        'Меню "Фитес"',
        'Меню "Фитес" - это новый подход к приготовлению блюд: больше свежих овощей и фруктов.' +
